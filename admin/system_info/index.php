	...
	<div class="card card-outline rounded-0 card-primary">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="" class="control-label">Carátula Sitio Web</label>
					<div class="custom-file">
				...
				<div class="form-group">
					<label for="" class="control-label">Galeria Imágenes</label>
					<div class="custom-file">
					...
					<small><i>Elija cargar nuevas imágenes en la galería</i></small>
				</div>
				<?php
...
<script>
	...
	$(document).ready(function() {
		$('.rem_img').click(function() {
			_conf("¿Seguro deseas eliminar esta imagen de forma permanente?", 'delete_img', ["'" + $(this).attr('data-path') + "'"])
		})
