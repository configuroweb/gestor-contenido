  ...
  <div class="row">
    <div class="col-12 col-sm-4 col-md-4 col-sm-12 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">Escritores</span>
    ...
    <div class="col-12 col-sm-6 col-md-6 col-sm-12 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">Contenido sin publicar</span>
          <span class="info-box-number">
            <?php
    ...
    <div class="col-12 col-sm-6 col-md-6 col-sm-12 col-xs-12">
      <div class="info-box">
        <span class="info-box-icon bg-gradient-warning elevation-1"><i class="fas fa-blog"></i></span>
