...
<div class="card card-outline rounded-0 card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a class="btn btn-sm btn-flat btn-warning" id="create_new" href="./?page=transactions/manage_transaction"><i class="fa fa-plus"></i> Add New Shipment</a>
		</div>
	</div>
	<div class="card-body">
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td><?= date("Y-m-d H:i", strtotime($row['date_created'])) ?></p>
								</td>
								<td>
									<p class="m-0 truncate-1"><?= $row['ref_code'] ?></p>
								</td>
								<td>
									<p class="m-0 truncate-1 text-right"><?= format_num($row['total_amount']) ?></p>
								</td>
