					...
					?>
						<tr>
							...
							<td class="text-center">
								<?php if ($row['status'] == 1) : ?>
									<span class="badge badge-primary px-3 rounded-pill">Publicado</span>
								<?php else : ?>
									<span class="badge badge-secondary px-3 rounded-pill">Sin-Publicar</span>
								<?php endif; ?>
							</td>
							<td align="center">
								...
								<div class="dropdown-menu" role="menu">
									<a class="dropdown-item view_data" href="./?page=articles/view_article&id=<?= $row['id'] ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> Ver</a>
...
<script>
	$(document).ready(function() {
		$('.delete_data').click(function() {
			_conf("¿Estás seguro de eliminar esta publicación de forma permanente?", "delete_article", [$(this).attr('data-id')])
		})
		$('.table').dataTable({
			columnDefs: [{
				orderable: false,
